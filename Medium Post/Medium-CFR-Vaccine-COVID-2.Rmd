---
title: "Part 2: Exploring the effects of vaccines at country level to reduce the case fatality rate for COVID-19"
author: "Pablo Busch"
date: "August 2022"
output:
  html_document:
...
All the model fitting, tables and figures creation are done using R. All the code is available at my [GitHub](https://github.com/pmbusch/COVID19-Vaccine-CFR). Please visit it if you want to learn more about the code and R libraries used in this post! \newline 
...
The results shows that a 10% increase in the percentage of vaccinated people results in a reduction of the COVID-19 CFR of 4.27% [C.I. 95%: -6.04%; -2.47%], a similar result that the one obtained in [Liang et al. (2021)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8285768/): -7.6% [C.I. 95%: -12.6%; -2.7%]. \newline
