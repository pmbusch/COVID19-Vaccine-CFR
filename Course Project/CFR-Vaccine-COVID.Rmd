...
**Results**: A statistical significant relationship was found, higher vaccination rates in a country reduces the relative risk of COVID-19. In comparison to the group with 0%-25% vaccinated people, countries in the 25%-50% group have a 18% [C.I. 95%: -26%;-10%] lower CFR for COVID-19, countries in the 50%-75% group have a 17% reduction [-26%;-7%] and countries in the 75%-100% group have a 38% reduction [-46%;-27%]. Additionally, a 10% increase in the percentage of vaccinated people results in a reduction of the COVID-19 CFR of 4.32% [C.I. 95%: -6.09%; -2.52%]. Potential limitations of the analysis are due to the potential presence of time and spatial autocorrelation in the data. \newline
...
We observe that countries with vaccination rates between 25%-50% have a 18% reduction in the CFR for COVID-19, compared to countries in the 0%-25% vaccination group. This reduction is different for higher vaccination rates, as the reduction for the group 50%-75% is 17% and for the group 75%-100% is 37%. \newline
...
location_coefficients %>% 
  ...
  coord_flip()+
  guides(col=F)+
  labs(x="WHO Region",col="",y="Relative Risk (RR): Country.Reference country: United States")
```
...
The model with vaccination level as numeric variable shows that a 10% increase in the percentage of vaccinated people results in a reduction of the COVID-19 CFR of 4.32% [C.I. 95%: -6.09%; -2.52%], a similar result that the one obtained in Liang et al. (2021): -7.6% [C.I. 95%: -12.6%; -2.7%]. \newline
